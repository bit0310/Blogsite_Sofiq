...
$id = $_GET['id'];
$queryResult = $login->getCategoryInfoById($id);
$category = mysqli_fetch_assoc($queryResult);


$message ="";
if(isset($_POST['btn'])){
    $message =  $login->updateCategoryInfo($_POST);
}
                    ...
                    <form action="" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $category['id'];  ?>" />
                            </div>
                        </div>
                        <div class="form-group row">
